defmodule MercuryWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MercuryWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MercuryWeb.Gettext, "errors", msg, opts)
    end
  end
